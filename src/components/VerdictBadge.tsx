...
const styles: Record<Verdict, string> = {
  ...
  SLOP: "bg-red-500/15 text-red-400 ring-red-500/30",
  FLAWED: "bg-amber-500/15 text-amber-400 ring-amber-500/30",
  PASSABLE: "bg-sky-500/15 text-sky-400 ring-sky-500/30",
};
