export const siteConfig = {
  ...
  description:
    "Independent AI tool reviews. We test bold marketing claims and deliver clear verdicts: PASSES, FAILS, MIXED, or QUALIFIED PASS.",
  instagramUrl: process.env.NEXT_PUBLIC_INSTAGRAM_URL ?? "https://instagram.com",
  instagramHandle: process.env.NEXT_PUBLIC_INSTAGRAM_HANDLE ?? "@verdictai",
